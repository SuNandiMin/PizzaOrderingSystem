        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{ asset('storage/images/pizza_images/' . $product->image) }}"
                                alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <small class="pt-1">{{ $product->waiting_time }}min - Wait</small>
                    <div>
                        <small class="text-dark text-bold"><i class="fa-regular fa-eye text-bold" style="color: #cc141e;"></i> {{ $product->view_count+1 }}</small>
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button class="btn btn-primary px-3" id="addCartBtn" type="button">
                    ...
                    @foreach ($products as $p)
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('storage/images/pizza_images/' . $p->image) }}"
                                    alt="">
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="More Detail"
                                        href="{{ route('pizza#detail', $p->id) }}">
                                        <i class="fa fa-info"></i>
                                    </a>
                                </div>
                            </div>
                            <div class="text-center py-4" style="background-color: darkgoldenrod">
...
@section('jsSource')
    ...
    <script>
        $(document).ready(function() {
            ...
            //increase View Count When reach detail Page
            $.ajax({
               type: 'get',
               url : '/pizza/ajax/increasing-view-count',
                dataType :'json',
                data :{
